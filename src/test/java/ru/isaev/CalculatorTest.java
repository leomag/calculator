...
class CalculatorTest {
    ...
    void isOdd_ShouldReturnTrueForOddNumbers(int... numbers) {
        assertEquals(-3, calculator.multiply(Arrays.stream(numbers).toArray()));
    }
    ...
    void divide() {
        assertAll(() -> assertEquals(1, calculator.divide(2, 2)),
                () -> assertEquals(2, calculator.divide(4, 2)));//                () -> assertEquals(0, calculator.divide(2, -2)),
//                () -> assertEquals(0, calculator.divide(2, -2)),
//                () -> assertEquals(0, calculator.divide(-2, -2)),
//
    }
...
//        assertEquals(exception.getMessage(), () -> calculator.divide(6, 0));
    }
